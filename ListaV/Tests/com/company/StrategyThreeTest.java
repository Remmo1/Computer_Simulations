...
class StrategyThreeTest {
    public static void main(String[] args) {

        assertEquals(4-2, 2);

        // strategia 3: przykład normalny
        ...
        StrategyThree strategyThree = new StrategyThree(processors, processes, 40, 20, 50);
        strategyThree.showResults();



        // strategia 3: przykład przeciążony
        System.out.println();
        Processor P1a = new Processor("P1a", 0);
        ...
        StrategyThree strategyThree2 = new StrategyThree(processors2, processes2, 40, 20, 50);
        strategyThree2.showResults();

        // strategia 3: przykład wredny
        System.out.println();
        ...
        StrategyThree strategyThree3 = new StrategyThree(processors3, processes3, 40, 20, 50);
        strategyThree3.showResults();
